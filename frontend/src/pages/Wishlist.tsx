...
const mockWishlistItems = [
  {
    ...
    discount: 0,
    stock: 10,
    description: 'Vestido floral com estampa delicada, perfeito para o verão'
  },
  {
    id: '2',
    name: 'Blusa Básica',
    ...
    discount: 10,
    stock: 5,
    description: 'Blusa básica em algodão, versátil para qualquer ocasião'
  },
  {
    id: '3',
    name: 'Calça Jeans',
    ...
    discount: 15,
    stock: 3,
    description: 'Calça jeans skinny com tecido de alta qualidade'
  }
];
